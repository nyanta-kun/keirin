...
**効果**（本番コードでの再現・test 2025-10-01〜2026-08-03）:

| 指標 | 7車 (n=19,424) | 9車 (n=1,848) |
|---|---|---|
| 軸2車ともに3着内 | 52.2→52.7% (+0.56pt・有意) | 39.7→41.1% (+1.41pt・有意) |
| Brier | 0.19044→0.18878 | 0.18308→0.18031 |
| 改善した月 | 8/11 | 9/11 |
